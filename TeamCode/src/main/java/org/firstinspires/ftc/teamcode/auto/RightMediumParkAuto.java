...
@Autonomous(name="Right Medium Park Auto", group="")
public class RightMediumParkAuto extends ConfiguredOpMode {
	...
	public void superInit() {
		...
		sequence = new TrajectorySequenceStorage().rightMediumPark(
				r,
				mecanum,
				lift,
				intake,
	...
	public void superStart() {
		sequence.addShortRightParkSequence(webcam.getTagId());
		webcam.closeStream();
