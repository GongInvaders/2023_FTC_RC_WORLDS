...
public class RobotConstants {
    ...
    public static final double armFrontDelivery = (armFront + (armMiddle/2) - 0.1)/2;
    public static final double armBackDelivery = armBack - (armMiddle/2) + 0.1 + (armBack -(armBack - (armMiddle/2) + 0.1)) / 2;
