...
import org.firstinspires.ftc.teamcode.teamUtil.odometry.roadrunner.trajectorysequence.TrajectorySequenceBuilder;
import org.firstinspires.ftc.teamcode.teamUtil.odometry.roadrunner.trajectorysequence.TrajectorySequenceRunner;
import org.firstinspires.ftc.teamcode.teamUtil.odometry.roadrunner.util.LynxModuleUtil;
...
public class SampleMecanumDrive extends MecanumDrive {
    public static PIDCoefficients TRANSLATIONAL_PID = new PIDCoefficients(1, 0, 0.1);
    public static PIDCoefficients HEADING_PID = new PIDCoefficients(10, 0, 0.1);

    public static double LATERAL_MULTIPLIER = 1.0169491525423728;
    ...
    public SampleMecanumDrive(HardwareMap hardwareMap) {
        ...
        leftFront = hardwareMap.get(DcMotorEx.class, ConfigNames.frontLeft);
        leftRear = hardwareMap.get(DcMotorEx.class, ConfigNames.backLeft);
        rightRear = hardwareMap.get(DcMotorEx.class, ConfigNames.backRight);
        rightFront = hardwareMap.get(DcMotorEx.class, ConfigNames.frontRight);
